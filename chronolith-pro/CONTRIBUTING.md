...
This project follows a merit-based governance model. Total project alignment is tracked via the chronolith system itself. See the upstream `MAINTAINERS.md` for more information on roles and leadership.
